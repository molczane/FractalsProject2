    ...
    \begin{columns}
        ...
        \end{column}
            \begin{column}{0.5\textwidth}
                \begin{figure}
                    \centering
                    \includegraphics[width=\textwidth]{assets/box_counting_verification.png}
...
\begin{frame}{Funkcja Weierstrassa}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{assets/weierstrass_box_counting.png}
...
\begin{frame}{Wpływ parametrów $a$ i $b$ na wymiar}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\textwidth]{assets/weierstrass_dimension_vs_a.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\textwidth]{assets/weierstrass_dimension_vs_b.png}
        \end{column}
    \end{columns}
...
\begin{frame}{Analiza wymiaru krzywych Peano i Hilberta}
    \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{assets/space_filling_dimensions_vs_order.png}
...
\begin{frame}{Fraktalne Funkcje Interpolacyjne (FIF)}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{assets/fif_application.png}
